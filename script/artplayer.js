...
!(function (e, t, r, o, i) {
  ...
  function c(t, r) {
    if (!s[t]) {
      ...
      e[t][0].call(p.exports, u, p, p.exports, this)
    }
    return s[t].exports
    function u(e) {
      var t = u.resolve(e)
...
})(
  {
    E13ST: [
      function (e, t, r) {
        ...
        var i = e('bundle-text:./style/index.less'),
          ...
          M = e('./contextmenu'),
          I = o.interopDefault(M),
          F = e('./info'),
          $ = o.interopDefault(F),
          T = e('./subtitle'),
          E = o.interopDefault(T),
          P = e('./events'),
          C = o.interopDefault(P),
          z = e('./hotkey'),
          D = o.interopDefault(z),
          Y = e('./layer'),
          A = o.interopDefault(Y),
          R = e('./loading'),
          O = o.interopDefault(R),
          L = e('./notice'),
          N = o.interopDefault(L),
          H = e('./mask'),
          V = o.interopDefault(H),
          J = e('./icons'),
          _ = o.interopDefault(J),
          q = e('./setting'),
          W = o.interopDefault(q),
          B = e('./storage'),
          U = o.interopDefault(B),
          Z = e('./plugins'),
          X = o.interopDefault(Z),
          K = e('./mobile'),
        ...
        class te extends c.default {
          constructor(e, t) {
            ...
            if (
              ...
              (this.isRotate = !1),
              (this.isDestroy = !1),
              (this.whitelist = new (0, g.default)(this)),
              (this.template = new (0, v.default)(this)),
              (this.events = new (0, C.default)(this)),
              this.whitelist.state
                ? ((this.storage = new (0, U.default)(this)),
                  (this.icons = new (0, _.default)(this)),
                  (this.i18n = new (0, x.default)(this)),
                  (this.notice = new (0, N.default)(this)),
                  (this.player = new (0, j.default)(this)),
                  (this.layers = new (0, A.default)(this)),
                  (this.controls = new (0, S.default)(this)),
                  (this.contextmenu = new (0, I.default)(this)),
                  (this.subtitle = new (0, E.default)(this)),
                  (this.info = new (0, $.default)(this)),
                  ...
                  (this.plugins = new (0, X.default)(this)))
                : (this.mobile = new (0, G.default)(this)),
              'function' == typeof t && this.on('ready', () => t.call(this, this)),
              te.DEGUG)
            ) {
              ...
              for (let t = 0; t < h.default.events.length; t++)
                this.on('video:' + h.default.events[t], t => e('Event@' + t.type))
            }
            ee.push(this)
          }
          ...
          static get option() {
            return {
              ...
              subtitle: { url: '', type: '', style: {}, encoding: 'utf-8' },
              moreVideoAttr: { controls: !1, preload: p.isSafari ? 'auto' : 'metadata' },
              icons: {},
              customType: {},
        ...
        if (
          ...
          (te.SETTING_ITEM_HEIGHT = 35),
          (te.INDICATOR_SIZE = 14),
          (te.INDICATOR_SIZE_ICON = 16),
          (te.INDICATOR_SIZE_MOBILE = 18),
          (te.INDICATOR_SIZE_MOBILE_ICON = 20),
          (te.VOLUME_PANEL_WIDTH = 60),
          (te.VOLUME_HANDLE_WIDTH = 12),
          (te.RESIZE_TIME = 500),
          (te.SCROLL_TIME = 200),
          (te.SCROLL_GAP = 50),
          ...
          (te.CONTROL_HIDE_TIME = 3e3),
          (te.DB_CLICE_TIME = 300),
          (te.MOBILE_AUTO_PLAYBACKRATE = 3),
          (te.MOBILE_AUTO_PLAYBACKRATE_TIME = 1e3),
          (te.MOBILE_AUTO_ORIENTATION_TIME = 200),
          (te.INFO_LOOP_TIME = 1e3),
          (te.FAST_FORWARD_VALUE = 3),
          (te.FAST_FORWARD_TIME = 1e3),
          (te.TOUCH_MOVE_RATIO = 0.5),
          (te.VOLUME_STEP = 0.1),
          (te.SEEK_STEP = 5),
          'undefined' != typeof document && !document.getElementById('artplayer-style'))
        ) {
          const e = p.createElement('style')
          ;(e.id = 'artplayer-style'), (e.textContent = a.default), document.head.appendChild(e)
        }
        'undefined' != typeof window && (window.Artplayer = te),
          console.log(
            `%c ArtPlayer %c ${te.version} %c https://artplayer.org`,
      ...
      {
        'bundle-text:./style/index.less': '6U764',
        'option-validator': 'eaJBf',
        './utils/emitter': '1SgiG',
        './utils': '5yYFo',
        './scheme': '3izFE',
        './config': 'ej4fZ',
        ...
        './plugins': '1v13t',
        './mobile': 'eD5Ch',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY'
      }
    ],
    '6U764': [
      function (e, t, r) {
              ...
              (function (e, t, o) {
                ...
                if ('object' === s) {
                  if ('object' !== l)
                    throw new Error(
                      "[Type Error]: '"
                        .concat(o.join('.'), "' require 'object' type, but got '")
                        .concat(l, "'")
                    )
                ...
                if ('array' === s) {
                  if ('array' !== l)
                    throw new Error(
                      "[Type Error]: '"
                        .concat(o.join('.'), "' require 'array' type, but got '")
                        .concat(l, "'")
                    )
                  e.forEach(function (r, s) {
                    var l = e[s],
                      c = t[s] || t[0],
                      p = o.slice()
                    p.push(s), a(l, c, p), n(l, c, p), i(l, c, p)
                  })
                }
              })(e, t, o),
              e
                ...
                throw 'string' === a
                  ...
                  : new Error(
                      "[Validator Error]: The scheme for '"
                        .concat(o.join('.'), "' validator require return true, but got '")
                        .concat(i, "'")
                    )
              }
            }
          ...
          off(e, t) {
            ...
            if (o && t)
              for (let e = 0, r = o.length; e < r; e += 1)
                o[e].fn !== t && o[e].fn._ !== t && i.push(o[e])
    ...
    fqaW9: [
      function (e, t, r) {
        ...
        o.defineInteropFlag(r),
          o.export(r, 'query', () => a),
          o.export(r, 'queryAll', () => n),
          o.export(r, 'addClass', () => s),
          ...
          o.export(r, 'tooltip', () => y),
          o.export(r, 'isInViewport', () => v),
        ...
        function p(e, t) {
          return (
            t instanceof Element ? e.appendChild(t) : e.insertAdjacentHTML('beforeend', String(t)),
      ...
      { './compatibility': 'e9wVp', '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY' }
    ],
    e9wVp: [
      function (e, t, r) {
        var o = e('@parcel/transformer-js/src/esmodule-helpers.js')
        o.defineInteropFlag(r),
          o.export(r, 'userAgent', () => i),
          o.export(r, 'isMobile', () => a),
          o.export(r, 'isSafari', () => n),
          o.export(r, 'isWechat', () => s),
          o.export(r, 'isIE', () => l),
          o.export(r, 'isAndroid', () => c),
          o.export(r, 'isIOS', () => p)
        const i = 'undefined' != typeof window ? window.navigator.userAgent : '',
          ...
          c = /android/i.test(i),
          p = /iPad|iPhone|iPod/i.test(i) && !window.MSStream
      },
      { '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY' }
    ],
    kNZvP: [
    ...
    '3izFE': [
      function (e, t, r) {
        ...
        r.default = {
          ...
          subtitle: { url: s, type: s, style: c, encoding: s },
          moreVideoAttr: c,
          icons: c,
          customType: c
        }
      },
      { '../utils': '5yYFo', '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY' }
    ],
    ej4fZ: [
      function (e, t, r) {
        e('@parcel/transformer-js/src/esmodule-helpers.js').defineInteropFlag(r),
    ...
    '8iGAh': [
      function (e, t, r) {
        ...
        class i {
          constructor(e) {
            this.art = e
            const { option: t, constructor: r, whitelist: i } = e
            t.container instanceof Element
              ? (this.$container = t.container)
              : ((this.$container = (0, o.query)(t.container)),
                (0, o.errorHandle)(this.$container, `No container element found by ${t.container}`))
            const a = this.$container.tagName.toLowerCase()
            ;(0, o.errorHandle)(
              'div' === a,
              `Unsupported container element type, only support 'div' but got '${a}'`
            ),
              (0, o.errorHandle)(
                r.instances.every(e => e.template.$container !== this.$container),
              ...
              i.state ? this.desktop() : this.mobile()
          }
          static get html() {
          ...
          desktop() {
            ...
            e.useSSR || (this.$container.innerHTML = i.html),
              ...
              e.backdrop &&
                ((0, o.addClass)(this.$setting, 'art-backdrop-filter'),
                (0, o.addClass)(this.$contextmenu, 'art-backdrop-filter'),
                (0, o.addClass)(this.$info, 'art-backdrop-filter')),
          ...
          destroy(e) {
            e
              ? (0, o.replaceElement)(this.$original, this.$container)
    ...
    bCaa0: [
      function (e, t, r) {
        ...
        var i = e('./urlMix'),
          ...
          S = e('./playbackRateMix'),
          M = o.interopDefault(S),
          I = e('./aspectRatioMix'),
          F = o.interopDefault(I),
          $ = e('./screenshotMix'),
          T = o.interopDefault($),
          E = e('./fullscreenMix'),
          P = o.interopDefault(E),
          C = e('./fullscreenWebMix'),
          z = o.interopDefault(C),
          D = e('./pipMix'),
          Y = o.interopDefault(D),
          A = e('./loadedMix'),
          R = o.interopDefault(A),
          O = e('./playedMix'),
          L = o.interopDefault(O),
          N = e('./playingMix'),
          H = o.interopDefault(N),
          V = e('./autoSizeMix'),
          J = o.interopDefault(V),
          _ = e('./rectMix'),
          q = o.interopDefault(_),
          W = e('./flipMix'),
          B = o.interopDefault(W),
          U = e('./miniMix'),
          Z = o.interopDefault(U),
          X = e('./loopMix'),
          K = o.interopDefault(X),
          G = e('./posterMix'),
          Q = o.interopDefault(G),
          ee = e('./autoHeightMix'),
      ...
      },
      {
        ...
        './seekMix': 'bsO1Q',
        './volumeMix': 'ivSmC',
        './currentTimeMix': '8LbXb',
        './durationMix': 'f7tNT',
        './switchMix': 'ejQWi',
        './playbackRateMix': 'kNcxE',
        './aspectRatioMix': '8v5yt',
        './screenshotMix': 'eLUEv',
        './fullscreenMix': 'ifvhR',
        './fullscreenWebMix': 'dsFtO',
        './pipMix': 'gYMLD',
        './loadedMix': 'fMSRd',
        './playedMix': 'iRHNE',
        './playingMix': 'dQ40z',
            ...
            async set(i) {
              if (i) {
                const a = t.type || (0, o.getExt)(i),
                  n = t.customType[a]
                a && n
                  ? (await (0, o.sleep)(), (e.loading.show = !0), n.call(e, r, i, e))
                  : (e.url &&
                      e.url !== i &&
    ...
    cZiBO: [
      function (e, t, r) {
        ...
        var o = e('../utils')
        r.default = function (e) {
          ;(0, o.def)(e, 'toggle', { value: () => (e.playing ? e.pause() : e.play()) })
        }
      },
      { '../utils': '5yYFo', '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY' }
    ],
          ...
          ;(0, o.def)(e, 'seek', {
            set(r) {
              ;(e.currentTime = r),
                ...
                e.duration &&
                  (t.show = `${(0, o.secondToTime)(e.currentTime)} / ${(0, o.secondToTime)(
                    e.duration
                  )}`)
            }
          }),
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          ;(0, o.def)(e, 'volume', {
            get: () => t.volume || 0,
            set: n => {
              ;(t.volume = (0, o.clamp)(n, 0, 1)),
                (i.show = `${r.get('Volume')}: ${parseInt(100 * t.volume, 10)}`),
                0 !== t.volume && a.set('volume', t.volume),
                e.emit('volume', t.volume)
            }
          }),
            (0, o.def)(e, 'muted', {
              get: () => t.muted,
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          ;(0, o.def)(e, 'currentTime', {
            ...
            set: r => {
              ;(r = parseFloat(r)),
                Number.isNaN(r) || (t.currentTime = (0, o.clamp)(r, 0, e.duration))
            }
          })
        }
      },
    ...
    ejQWi: [
      function (e, t, r) {
        ...
        var o = e('../utils')
        r.default = function (e) {
          const { i18n: t, option: r, notice: i } = e
          function a(o, a, n) {
              ...
              e.pause(),
                ...
                e.once('video:canplay', () => {
                  ;(e.playbackRate = !1),
                    ...
                    (e.notice.show = ''),
                    l && e.play(),
                    a && (i.show = `${t.get('Switch Video')}: ${a}`),
                    e.emit('switch', o),
                    s(o)
                })
            })
          }
          ;(0, o.def)(e, 'switchQuality', { value: (t, r) => a(t, r, e.currentTime) }),
            (0, o.def)(e, 'switchUrl', { value: (e, t) => a(e, t, 0) })
        }
      },
      { '../utils': '5yYFo', '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY' }
    ],
          ...
          ;(0, o.def)(e, 'playbackRate', {
            ...
            set(a) {
              if (a) {
                ...
                const n = [0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 3, 4]
                ;(0, o.errorHandle)(
                  n.includes(a),
                  `'playbackRate' only accept ${n.toString()} as parameters`
                ),
                  (t.playbackRate = a),
                  (i.show = `${r.get('Rate')}: ${1 === a ? r.get('Normal') : `${a}x`}`),
                  e.emit('playbackRate', a)
              } else (e.playbackRate = 1), e.emit('playbackRate')
            }
          })
        }
      },
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          ;(0, o.def)(e, 'aspectRatio', {
            ...
            set(n) {
              n || (n = 'default')
              const s = ['default', '4:3', '16:9']
              if (
                ((0, o.errorHandle)(
                  s.includes(n),
                  `'aspectRatio' only accept ${s.toString()} as parameters`
                ),
                'default' === n)
              )
                (0, o.setStyle)(t, 'width', null),
                  (0, o.setStyle)(t, 'height', null),
                  (0, o.setStyle)(t, 'padding', null),
                  delete r.dataset.aspectRatio
              else {
                const e = n.split(':').map(Number),
                  { videoWidth: i, videoHeight: a } = t,
                  { clientWidth: s, clientHeight: l } = r,
                  c = i / a,
                  p = e[0] / e[1]
                if (c > p) {
                  const e = (p * a) / i
                  ;(0, o.setStyle)(t, 'width', 100 * e + '%'),
                    (0, o.setStyle)(t, 'height', '100%'),
                    (0, o.setStyle)(t, 'padding', `0 ${(s - s * e) / 2}px`)
                } else {
                  const e = i / p / a
                  ;(0, o.setStyle)(t, 'width', '100%'),
                    (0, o.setStyle)(t, 'height', 100 * e + '%'),
                    (0, o.setStyle)(t, 'padding', (l - l * e) / 2 + 'px 0')
                }
                r.dataset.aspectRatio = n
              }
              ;(a.show = `${i.get('Aspect Ratio')}: ${'default' === n ? i.get('Default') : n}`),
                e.emit('aspectRatio', n)
            }
          }),
            (0, o.def)(e, 'aspectRatioReset', {
              set(t) {
                if (t) {
                  const { aspectRatio: t } = e
                  e.aspectRatio = t
                }
              }
            })
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          const {
            ...
            a = (0, o.createElement)('canvas')
          ;(0, o.def)(e, 'getDataURL', {
            value: () =>
              new Promise((e, t) => {
                try {
                  ;(a.width = i.videoWidth),
                    (a.height = i.videoHeight),
                    a.getContext('2d').drawImage(i, 0, 0),
                    e(a.toDataURL('image/png'))
                } catch (e) {
                  ;(r.show = e), t(e)
                }
              })
            ...
            (0, o.def)(e, 'screenshot', {
              value: async () => {
                ...
                return (
                  (0, o.download)(
                    r,
                    `${t.title || 'artplayer'}_${(0, o.secondToTime)(i.currentTime)}.png`
                  ),
                  e.emit('screenshot', r),
                  r
                )
            ...
            a.default.isEnabled
              ? (e => {
                  ;(0, n.def)(e, 'fullscreen', {
                    ...
                    async set(t) {
                      t
                        ? ((e.normalSize = 'fullscreen'),
                          (e.aspectRatioReset = !0),
                          (e.autoSize = !1),
                          await a.default.request(i),
                          (0, n.addClass)(i, 'art-fullscreen'),
                          e.emit('resize'),
                          e.emit('fullscreen', !0),
                          (r.show = ''))
                        : ((e.aspectRatioReset = !0),
                          (e.autoSize = e.option.autoSize),
                          await a.default.exit(),
                          (0, n.removeClass)(i, 'art-fullscreen'),
                          e.emit('resize'),
                          e.emit('fullscreen', !1),
                          (r.show = ''))
                    }
                    ...
                    set(t) {
                      t
                        ? ((e.normalSize = 'fullscreen'),
                          ...
                          e.emit('fullscreen', !0),
                          (r.show = ''))
                        : (o.webkitExitFullscreen(), e.emit('fullscreen', !1), (r.show = ''))
                    }
                  })
                })(e)
              : (0, n.def)(e, 'fullscreen', {
    ...
    dXDKn: [
      function (e, t, r) {
        ...
        Object.defineProperties(n, {
          isFullscreen: { get: () => Boolean(document[i.fullscreenElement]) },
          element: { enumerable: !0, get: () => document[i.fullscreenElement] },
          isEnabled: { enumerable: !0, get: () => Boolean(document[i.fullscreenEnabled]) }
        }),
          i || (n = { isEnabled: !1 }),
          (r.default = n)
      },
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          ;(0, o.def)(e, 'fullscreenWeb', {
            ...
            set(i) {
              i
                ? ((e.normalSize = 'fullscreenWeb'),
                  (0, o.addClass)(r, 'art-fullscreen-web'),
                  (e.aspectRatioReset = !0),
                  (e.autoSize = !1),
                  e.emit('resize'),
                  e.emit('fullscreenWeb', !0),
                  (t.show = ''))
                : ((0, o.removeClass)(r, 'art-fullscreen-web'),
                  (e.aspectRatioReset = !0),
                  (e.autoSize = e.option.autoSize),
                  e.emit('resize'),
                    ...
                    set(r) {
                      r
                        ? ((e.normalSize = 'pip'),
                          ...
                          e.emit('pip', !0))
                        : (t.webkitSetPresentationMode('inline'), e.emit('pip', !1))
                    }
                  })
              })(e)
            : (0, o.def)(e, 'pip', {
    ...
    iF844: [
      function (e, t, r) {
        ...
        var o = e('../utils')
        r.default = function (e) {
          const { $container: t, $player: r, $video: i } = e.template
          ;(0, o.def)(e, 'autoSize', {
            get: () => (0, o.hasClass)(t, 'art-auto-size'),
            set(a) {
              if (a) {
                const { videoWidth: a, videoHeight: n } = i,
                  { width: s, height: l } = t.getBoundingClientRect(),
                  c = a / n,
                  p = s / l
                if (((0, o.addClass)(t, 'art-auto-size'), p > c)) {
                  const e = ((l * c) / s) * 100
                ...
                (0, o.removeClass)(t, 'art-auto-size'),
                  (0, o.setStyle)(r, 'width', null),
                  (0, o.setStyle)(r, 'height', null),
                  e.emit('autoSize')
            }
          })
        }
    ...
    '1hAm8': [
      function (e, t, r) {
        ...
        var o = e('../utils')
        r.default = function (e) {
          ;(0, o.def)(e, 'rect', { get: () => e.template.$player.getBoundingClientRect() })
          const t = ['bottom', 'height', 'left', 'right', 'top', 'width']
          for (let r = 0; r < t.length; r++) {
            const i = t[r]
            ;(0, o.def)(e, i, { get: () => e.rect[i] })
          }
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          ;(0, o.def)(e, 'flip', {
            ...
            set(a) {
              a || (a = 'normal')
              const n = ['normal', 'horizontal', 'vertical']
              ;(0, o.errorHandle)(
                n.includes(a),
                `'flip' only accept ${n.toString()} as parameters`
              ),
                'normal' === a ? delete t.dataset.flip : (t.dataset.flip = a)
              const s = a.replace(a[0], a[0].toUpperCase())
              ;(i.show = `${r.get('Video Flip')}: ${r.get(s)}`), e.emit('flip', a)
            }
          })
        }
      },
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          const {
            ...
            storage: i,
            proxy: a,
            template: { $player: n, $miniClose: s, $miniTitle: l, $miniHeader: c }
          } = e
          let p = !1,
            u = 0,
            d = 0,
            ...
            h = 0
          a(c, 'mousedown', t => {
            ;(p = !0), (u = t.pageX), (d = t.pageY), (f = e.left), (h = e.top)
          }),
            a(document, 'mousemove', e => {
              if (p) {
                ...
                const t = h + e.pageY - d,
                  r = f + e.pageX - u
                ;(0, o.setStyle)(n, 'top', `${t}px`),
                  (0, o.setStyle)(n, 'left', `${r}px`),
                  i.set('top', t),
                  i.set('left', r)
              }
            }),
            a(document, 'mouseup', () => {
              ;(p = !1), (0, o.removeClass)(n, 'art-is-dragging')
            }),
            a(s, 'click', () => {
              ;(e.mini = !1), (p = !1), (0, o.removeClass)(n, 'art-is-dragging')
            }),
            (0, o.append)(l, r.title || t.get('Mini Player')),
            (0, o.def)(e, 'mini', {
              ...
              set(t) {
                if (t) {
                  ...
                  if (t && r)
                    (0, o.setStyle)(n, 'top', `${t}px`),
                      (0, o.setStyle)(n, 'left', `${r}px`),
                      (0, o.isInViewport)(c) || (i.del('top'), i.del('left'), (e.mini = !0))
                  else {
                  ...
                  (0, o.removeClass)(n, 'art-mini'),
                    (0, o.setStyle)(n, 'top', null),
                    (0, o.setStyle)(n, 'left', null),
                    (e.aspectRatio = !1),
                    (e.playbackRate = !1),
                    (e.autoSize = r.autoSize),
                    (e.notice.show = ''),
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          ;(0, o.def)(e, 'autoHeight', {
            ...
            set(n) {
              if (n) {
                const { clientWidth: a } = r,
                  { videoHeight: n, videoWidth: s } = i,
                  l = n * (a / s)
                ;(0, o.setStyle)(r, 'height', l + 'px'),
                  (0, o.addClass)(r, 'art-auto-height'),
                  (e.autoSize = t.autoSize),
                  e.emit('autoHeight', l)
              } else
                (0, o.setStyle)(r, 'height', a),
                  (0, o.removeClass)(r, 'art-auto-height'),
                  (e.autoSize = t.autoSize),
                  e.emit('autoHeight')
            }
          })
              ...
              set(o) {
                if (i.$track && i.$track.track) {
                  ...
                  for (let r = 0; r < l.length; r++) {
                    const o = l[r]
                    s[r] || (s[r] = { startTime: o.startTime, endTime: o.endTime }),
                      (o.startTime = t(s[r].startTime + n, 0, e.duration)),
    ...
    bDxGv: [
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          let n = !0
          window.WebKitPlaybackTargetAvailabilityEvent && a.webkitShowPlaybackTargetPicker
            ? i(a, 'webkitplaybacktargetavailabilitychanged', e => {
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          const {
            option: t,
            storage: r,
            template: { $video: i, $poster: a }
          } = e
          Object.keys(t.moreVideoAttr).forEach(r => {
            e.attr(r, t.moreVideoAttr[r])
          }),
            t.muted && (e.muted = t.muted),
            t.volume && (i.volume = (0, o.clamp)(t.volume, 0, 1))
          const n = r.get('volume')
          'number' == typeof n && (i.volume = (0, o.clamp)(n, 0, 1)),
            t.poster && (0, o.setStyle)(a, 'backgroundImage', `url(${t.poster})`),
            t.autoplay && (i.autoplay = t.autoplay),
            t.playsInline && ((i.playsInline = !0), (i['webkit-playsinline'] = !0)),
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          e.on('video:canplay', () => {
            ...
            e.on('video:ended', () => {
              o.loop
                ? ((e.seek = 0), e.play(), (e.controls.show = !1), (e.mask.show = !1))
                : ((e.controls.show = !0), (e.mask.show = !0))
            }),
            e.on('video:error', async () => {
              u < i.RECONNECT_TIME_MAX
                ? (await (0, n.sleep)(i.RECONNECT_SLEEP_TIME),
                  (u += 1),
                  (e.url = o.url),
                ...
                : ((e.mask.show = !0),
                  (e.loading.show = !1),
                  (e.controls.show = !0),
                  (0, n.addClass)(l, 'art-error'),
                  await (0, n.sleep)(i.RECONNECT_SLEEP_TIME),
                  (r.show = t.get('Video Load Failed')),
                  e.destroy(!1))
            }),
            e.on('video:loadedmetadata', () => {
              ;(e.autoSize = o.autoSize),
                n.isMobile && ((e.loading.show = !1), (e.controls.show = !0), (e.mask.show = !0))
            }),
        ...
        class z extends n.default {
          constructor(e) {
            ...
            t(o, ['click', 'mousemove', 'touchstart', 'touchmove'], () => {
              ;(this.show = !0),
                (0, i.removeClass)(o, 'art-hide-cursor'),
                (0, i.addClass)(o, 'art-hover'),
                (a = Date.now())
            }),
              e.on('video:timeupdate', () => {
                !e.isInput &&
                  e.playing &&
                  this.show &&
                  Date.now() - a >= r.CONTROL_HIDE_TIME &&
                  ((this.show = !1),
                  (0, i.addClass)(o, 'art-hide-cursor'),
                  (0, i.removeClass)(o, 'art-hover'))
              }),
              this.init()
          }
          init() {
            const { option: e } = this.art
            e.isLive || this.add((0, g.default)({ name: 'progress', position: 'top', index: 10 })),
              !e.thumbnails.url ||
                e.isLive ||
                i.isMobile ||
                this.add((0, S.default)({ name: 'thumbnails', position: 'top', index: 20 })),
              this.add((0, E.default)({ name: 'loop', position: 'top', index: 30 })),
              this.add((0, h.default)({ name: 'playAndPause', position: 'left', index: 10 })),
              this.add((0, x.default)({ name: 'volume', position: 'left', index: 20 })),
              e.isLive || this.add((0, v.default)({ name: 'time', position: 'left', index: 30 })),
              e.quality.length &&
                this.add((0, $.default)({ name: 'quality', position: 'right', index: 10 })),
              e.screenshot &&
                !i.isMobile &&
                this.add((0, I.default)({ name: 'screenshot', position: 'right', index: 20 })),
              e.setting &&
                this.add((0, j.default)({ name: 'setting', position: 'right', index: 30 })),
              e.pip && this.add((0, d.default)({ name: 'pip', position: 'right', index: 40 })),
              e.airplay &&
                window.WebKitPlaybackTargetAvailabilityEvent &&
                this.add((0, C.default)({ name: 'airplay', position: 'right', index: 50 })),
              e.fullscreenWeb &&
                this.add((0, p.default)({ name: 'fullscreenWeb', position: 'right', index: 60 })),
              e.fullscreen &&
                this.add((0, l.default)({ name: 'fullscreen', position: 'right', index: 70 }))
            for (let t = 0; t < e.controls.length; t++) this.add(e.controls[t])
          }
          add(e) {
            const t = 'function' == typeof e ? e(this.art) : e,
              { $progress: r, $controlsLeft: o, $controlsRight: a } = this.art.template
            switch (t.position) {
              case 'top':
                this.$parent = r
                break
      ...
      function (e, t, r) {
        ...
        r.default = class {
          ...
          add(e) {
            ...
            if (
              ((t.html = t.html || ''),
              (0, n.default)(t, s.ComponentOption),
            ...
            ;(0, c.errorHandle)(
              !(0, l.has)(this, r),
              `Cannot add an existing name [${r}] to the [${this.name}]`
            ),
              (this.id += 1)
            ...
            const p = a.find(e => Number(e.dataset.index) >= Number(o.dataset.index))
            return (
              p ? p.insertAdjacentElement('beforebegin', o) : (0, i.append)(this.$parent, o),
              t.html && (0, i.append)(o, t.html),
              t.style && (0, i.setStyles)(o, t.style),
              t.tooltip && (0, i.tooltip)(o, t.tooltip),
              t.click &&
                this.art.events.proxy(o, 'click', e => {
                  e.preventDefault(), t.click.call(this.art, this, e)
                }),
              t.selector && ['left', 'right'].includes(t.position) && this.selector(t, o),
              t.mounted && t.mounted.call(this.art, o),
              1 === o.childNodes.length &&
                3 === o.childNodes[0].nodeType &&
                (0, i.addClass)(o, 'art-control-onlyText'),
              (0, l.def)(this, r, { value: o }),
              o
            )
          }
          selector(e, t) {
            const { hover: r, proxy: o } = this.art.events
            ;(0, i.addClass)(t, 'art-control-selector')
            const a = (0, i.createElement)('div')
            ;(0, i.addClass)(a, 'art-selector-value'),
              (0, i.append)(a, e.html),
              (t.innerText = ''),
              (0, i.append)(t, a)
            const n = e.selector
            ...
            r(t, l),
              o(s, 'click', async t => {
                const r = (t.composedPath() || []).find(e =>
                  (0, i.hasClass)(e, 'art-selector-item')
                )
                if (!r) return
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          return t => ({
            ...
            mounted: e => {
              const { proxy: r, icons: i, i18n: a } = t,
                n = (0, o.append)(e, i.fullscreenOn),
                s = (0, o.append)(e, i.fullscreenOff)
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          return t => ({
            ...
            mounted: e => {
              const { proxy: r, icons: i, i18n: a } = t,
                n = (0, o.append)(e, i.fullscreenWebOn),
                s = (0, o.append)(e, i.fullscreenWebOff)
              ;(0, o.setStyle)(s, 'display', 'none'),
                r(e, 'click', () => {
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          return t => ({
            ...
            mounted: e => {
              const { proxy: r, icons: i, i18n: a } = t,
                n = (0, o.append)(e, i.play),
                s = (0, o.append)(e, i.pause)
              function l() {
              ...
              ;(0, o.tooltip)(n, a.get('Play')),
                (0, o.tooltip)(s, a.get('Pause')),
                r(n, 'click', () => {
                  t.play()
                }),
                r(s, 'click', () => {
    ...
    '19nwD': [
      function (e, t, r) {
        ...
        o.defineInteropFlag(r),
          ...
          o.export(r, 'setCurrentTime', () => n)
        var i = e('../utils')
        function a(e, t) {
          const { $progress: r } = e.template,
            { left: o } = r.getBoundingClientRect(),
            a = i.isMobile ? t.touches[0].clientX : t.pageX,
            n = (0, i.clamp)(a - o, 0, r.clientWidth),
            s = (n / r.clientWidth) * e.duration
          return {
            second: s,
        ...
        r.default = function (e) {
          return t => {
            const { icons: r, option: o, proxy: s } = t
            return {
              ...e,
              ...
              mounted: e => {
                ...
                const c = (0, i.query)('.art-progress-loaded', e),
                  p = (0, i.query)('.art-progress-played', e),
                  u = (0, i.query)('.art-progress-highlight', e),
                  d = (0, i.query)('.art-progress-indicator', e),
                  f = (0, i.query)('.art-progress-tip', e)
                ;(0, i.setStyle)(p, 'backgroundColor', 'var(--theme)')
                let h = t.constructor.INDICATOR_SIZE
                function m(e, t) {
                  'loaded' === e && (0, i.setStyle)(c, 'width', 100 * t + '%'),
                    'played' === e &&
                      ((0, i.setStyle)(p, 'width', 100 * t + '%'),
                      (0, i.setStyle)(d, 'left', `calc(${100 * t}% - ${h / 2}px)`))
                }
                r.indicator
                  ? ((h = t.constructor.INDICATOR_SIZE_ICON), (0, i.append)(d, r.indicator))
                  : (0, i.setStyles)(d, { backgroundColor: 'var(--theme)' }),
                  i.isMobile &&
                    ((h = t.constructor.INDICATOR_SIZE_MOBILE),
                    r.indicator && (h = t.constructor.INDICATOR_SIZE_MOBILE_ICON)),
                  (0, i.setStyles)(d, { left: `-${h / 2}px`, width: `${h}px`, height: `${h}px` }),
                  t.on('video:loadedmetadata', () => {
                    for (let e = 0; e < o.highlight.length; e++) {
                      ...
                      ;(0, i.append)(
                        u,
                        `<span data-text="${r.text}" data-time="${r.time}" style="left: ${a}%"></span>`
                      )
                    }
                  }),
                  m('loaded', t.loaded),
                  ...
                  i.isMobile ||
                    ...
                    s(e, 'mousemove', r => {
                      ;(0, i.setStyle)(f, 'display', 'block'),
                        (0, i.includeFromEvent)(r, u)
                          ? (function (r) {
                              const { width: o } = a(t, r),
                                { text: n } = r.target.dataset
                              f.innerHTML = n
                              const s = f.clientWidth
                              o <= s / 2
                                ? (0, i.setStyle)(f, 'left', 0)
                                : o > e.clientWidth - s / 2
                                ? (0, i.setStyle)(f, 'left', e.clientWidth - s + 'px')
                                : (0, i.setStyle)(f, 'left', o - s / 2 + 'px')
                            })(r)
                          : (function (r) {
                              const { width: o, time: n } = a(t, r)
                              f.innerHTML = n
                              const s = f.clientWidth
                              o <= s / 2
                                ? (0, i.setStyle)(f, 'left', 0)
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          return t => ({
            ...
            mounted: e => {
              function r() {
                const r = `${(0, o.secondToTime)(t.currentTime)} / ${(0, o.secondToTime)(
                  t.duration
                )}`
          ...
          return t => ({
            ...
            mounted: e => {
              ...
              const s = t.constructor.VOLUME_PANEL_WIDTH,
                ...
                p = (0, o.append)(e, i.volumeClose),
                u = (0, o.append)(e, '<div class="art-volume-panel"></div>'),
                d = (0, o.append)(u, '<div class="art-volume-slider-handle"></div>')
              function f(e) {
                const { left: t } = u.getBoundingClientRect()
                return (0, o.clamp)(e.pageX - t - l / 2, 0, s - l / 2) / (s - l)
              }
              function h(e = 0.7) {
                if (t.muted || 0 === e)
                  (0, o.setStyle)(c, 'display', 'none'),
                    (0, o.setStyle)(p, 'display', 'flex'),
                    (0, o.setStyle)(d, 'left', '0')
                else {
                  const t = (s - l) * e
                  ;(0, o.setStyle)(c, 'display', 'flex'),
                    (0, o.setStyle)(p, 'display', 'none'),
                    (0, o.setStyle)(d, 'left', `${t}px`)
                }
              }
              ;(0, o.tooltip)(c, a.get('Mute')),
                (0, o.setStyle)(p, 'display', 'none'),
                o.isMobile && (0, o.setStyle)(u, 'display', 'none'),
                h(t.volume),
          ...
          return t => ({
            ...
            mounted: e => {
              ...
              s(a, 'mousemove', async s => {
                ...
                u &&
                  ((0, o.setStyle)(e, 'display', 'block'),
                  (function (s) {
                    const { width: l } = (0, i.getPosFromEvent)(t, s),
                      { url: p, number: u, column: d, width: f, height: h } = r.thumbnails,
                      m = f || c.naturalWidth / d,
                      g = h || m / (n.videoWidth / n.videoHeight),
                      y = a.clientWidth / u,
                      v = Math.floor(l / y),
                      b = Math.ceil(v / d) - 1,
                      x = v % d || d - 1
                    ;(0, o.setStyle)(e, 'backgroundImage', `url(${p})`),
                      ...
                      (0, o.setStyle)(e, 'backgroundPosition', `-${x * m}px -${b * g}px`),
                      l <= m / 2
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          return t => ({
            ...
            mounted: e => {
              const { proxy: r, icons: i } = t
              ;(0, o.append)(e, i.screenshot),
                r(e, 'click', () => {
                  t.screenshot()
                })
            }
                ...
                a
                  ? ((0, o.setStyle)(e, 'display', 'block'),
                    (0, o.setStyle)(
                      r,
                      'left',
                      `calc(${(a[0] / t.duration) * 100}% - ${r.clientWidth}px)`
                    ),
                    (0, o.setStyle)(i, 'left', (a[1] / t.duration) * 100 + '%'))
                  : (0, o.setStyle)(e, 'display', 'none')
              })
            }
          })
      ...
      function (e, t, r) {
        ...
        class b extends n.default {
          ...
          init() {
            ...
            e.playbackRate && this.add((0, l.default)({ name: 'playbackRate', index: 10 })),
              e.aspectRatio && this.add((0, p.default)({ name: 'aspectRatio', index: 20 })),
        ...
        r.default = function (e) {
          return t => {
            ...
            return {
              ...
              html: `${r.get(
                'Play Speed'
              )}:<span data-value="0.5">0.5</span><span data-value="0.75">0.75</span><span data-value="1.0" class="art-current">${r.get(
                'Normal'
              )}</span><span data-value="1.25">1.25</span><span data-value="1.5">1.5</span><span data-value="2.0">2.0</span>`,
              click: (e, r) => {
        ...
        r.default = function (e) {
          return t => {
            ...
            return {
              ...
              html: `${r.get(
                'Aspect Ratio'
              )}:<span data-value="default" class="art-current">${r.get(
                'Default'
              )}</span><span data-value="4:3">4:3</span><span data-value="16:9">16:9</span>`,
              click: (e, r) => {
                const { value: o } = r.target.dataset
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          return t => {
            ...
            return {
              ...e,
              html: `${r.get('Video Flip')}:<span data-value="normal" class="art-current">${r.get(
                'Normal'
              )}</span><span data-value="horizontal">${r.get(
                'Horizontal'
              )}</span><span data-value="vertical">${r.get('Vertical')}</span>`,
              click: (e, r) => {
                const { value: o } = r.target.dataset
                o && ((t.flip = o), (e.show = !1))
              },
        ...
        class u extends n.default {
          constructor(e) {
            ...
            e.on('video:timeupdate', () => {
              ...
              'boolean' == typeof e &&
                e !== t &&
                ((t = e), this.createTrack(e ? 'subtitles' : 'metadata', this.url))
            })
          }
          get url() {
            ...
            ;(e.innerHTML = ''),
              this.activeCue &&
                ((e.innerHTML = this.activeCue.text
                  .split(/\r?\n/)
                  .map(e => `<p>${(0, i.escape)(e)}</p>`)
                  .join('')),
                this.art.emit('subtitleUpdate', this.activeCue.text))
          }
          async switch(e, t = {}) {
            const { i18n: r, notice: o, option: i } = this.art,
              a = { ...i.subtitle, ...t, url: e },
              n = await this.init(a)
            return t.name && (o.show = `${r.get('Switch Subtitle')}: ${t.name}`), n
          }
          createTrack(e, t) {
            const { template: r, proxy: o } = this.art,
              { $video: a, $track: n } = r,
              s = (0, i.createElement)('track')
            ;(s.default = !0),
              (s.kind = e),
              (s.src = t),
              this.eventDestroy(),
              ...
              (0, i.append)(a, s),
              (r.$track = s),
              (this.eventDestroy = o(this.textTrack, 'cuechange', () => this.update()))
          }
          async init(e) {
            const {
              notice: t,
              ...
              return (
                ...
                fetch(e.url)
                  ...
                  .then(t => {
                    ...
                    switch (
                      (this.art.emit('subtitleLoad', e.url), e.type || (0, i.getExt)(e.url))
                    ) {
                      case 'srt':
          ...
          loadImg(e) {
            return new Promise((t, r) => {
              ...
              this.proxy(o, 'load', () => t(o)),
                this.proxy(o, 'error', () =>
                  r(new (0, i.ArtPlayerError)(`Failed to load Image: ${o.src}`))
                )
            })
          }
          destroy() {
    ...
    hrnqi: [
      function (e, t, r) {
        ...
        r.default = function (e, t) {
          const {
            constructor: r,
            template: { $player: i, $video: a }
          } = e
          t.proxy(document, ['click', 'contextmenu'], t => {
            ;(0, o.includeFromEvent)(t, i)
              ? ((e.isInput = 'INPUT' === t.target.tagName), (e.isFocus = !0), e.emit('focus'))
              : ((e.isInput = !1), (e.isFocus = !1), e.emit('blur'))
          })
          let n = 0
          t.proxy(a, 'click', () => {
            const t = Date.now()
            t - n <= r.DB_CLICE_TIME
              ? (e.emit('dblclick'),
                o.isMobile ? e.isLock || e.toggle() : (e.fullscreen = !e.fullscreen))
              : (e.emit('click'), o.isMobile || e.toggle()),
              (n = t)
          })
        }
      },
    ...
    '9c8lQ': [
      function (e, t, r) {
        ...
        r.default = function (e, t) {
          const { option: r } = e,
            i = (0, o.throttle)(() => {
              e.normalSize && (e.autoSize = r.autoSize),
                (e.aspectRatioReset = !0),
                (e.notice.show = ''),
                e.emit('resize')
          ...
          t.proxy(window, ['orientationchange', 'resize'], () => {
            ...
            screen &&
              ...
              t.proxy(screen.orientation, 'change', () => {
                i()
              })
        }
      },
      ...
      function (e, t, r) {
        ...
        r.default = function (e, t) {
          if (o.isMobile && !e.option.isLive) {
            const { $video: r, $progress: a } = e.template
            let n = null,
              s = !1,
              l = 0,
              c = 0,
            ...
            const u = t => {
                if (1 === t.touches.length && !e.isLock) {
                  ...
                  const { clientX: r, clientY: o } = t.touches[0]
                  ;(l = r), (c = o), (p = e.currentTime)
                }
              },
              d = t => {
                if (1 === t.touches.length && s && e.duration) {
                  const { clientX: i, clientY: a } = t.touches[0],
                    s = (0, o.clamp)((i - l) / e.width, -1, 1),
                    u = (0, o.clamp)((a - c) / e.height, -1, 1),
                    d = e.isRotate ? u : s,
                    f = n === r ? e.constructor.TOUCH_MOVE_RATIO : 1,
                    h = (0, o.clamp)(p + e.duration * d * f, 0, e.duration)
                  ;(e.seek = h),
                    e.emit('setBar', 'played', (0, o.clamp)(h / e.duration, 0, 1)),
                    (e.notice.show = `${(0, o.secondToTime)(h)} / ${(0, o.secondToTime)(
                      e.duration
                    )}`)
                }
              },
            ...
            t.proxy(a, 'touchstart', e => {
              ...
              t.proxy(r, 'touchmove', d),
              t.proxy(a, 'touchmove', d),
              t.proxy(document, 'touchend', f)
          }
        }
      },
      {
        '../utils': '5yYFo',
        '../control/progress': '19nwD',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY'
      }
    ],
    cJlT5: [
    ...
    kZD92: [
      ...
      { './utils/component': '5MLcx', '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY' }
    ],
    c9b9e: [
      function (e, t, r) {
        var o = e('@parcel/transformer-js/src/esmodule-helpers.js')
      ...
      function (e, t, r) {
        ...
        r.default = class {
          ...
          set show(e) {
            const {
              constructor: t,
              template: { $player: r, $noticeInner: i }
            } = this.art
            e
              ? ((i.innerText = e instanceof Error ? e.message.trim() : e),
        ...
        class s extends n.default {
          constructor(e) {
            ...
            const { template: t, icons: r, events: o } = e,
              a = (0, i.append)(t.$state, r.state),
              n = (0, i.append)(t.$state, r.error)
            ;(0, i.setStyle)(n, 'display', 'none'),
              e.on('destroy', () => {
    ...
    jx1Wu: [
      function (e, t, r) {
        ...
        var i = e('../utils'),
          ...
          S = o.interopDefault(k),
          M = e('bundle-text:./arrow-right.svg'),
          I = o.interopDefault(M),
          F = e('bundle-text:./playback-rate.svg'),
          $ = o.interopDefault(F),
          ...
          D = o.interopDefault(z),
          Y = e('bundle-text:./lock.svg'),
          A = o.interopDefault(Y),
          R = e('bundle-text:./unlock.svg'),
          O = o.interopDefault(R),
          L = e('bundle-text:./fullscreen-off.svg'),
          N = o.interopDefault(L),
          H = e('bundle-text:./fullscreen-on.svg'),
          V = o.interopDefault(H),
          J = e('bundle-text:./fullscreen-web-off.svg'),
          _ = o.interopDefault(J),
          q = e('bundle-text:./fullscreen-web-on.svg'),
          W = o.interopDefault(q),
          B = e('bundle-text:./switch-on.svg'),
          U = o.interopDefault(B),
        ...
        r.default = class {
          constructor(e) {
            const t = {
              ...
              flip: G.default,
              unlock: O.default,
              fullscreenOff: N.default,
              fullscreenOn: V.default,
              fullscreenWebOff: _.default,
            ...
            Object.keys(t).forEach(e => {
              ;(0, i.def)(this, e, {
                get: () => {
                  ...
                  return (
                    (0, i.addClass)(r, 'art-icon'),
                    (0, i.addClass)(r, `art-icon-${e}`),
                    (0, i.append)(r, t[e]),
                    r
                  )
                }
      ...
      {
        '../utils': '5yYFo',
        'bundle-text:./loading.svg': 'gFMCI',
        'bundle-text:./state.svg': 'iYMJD',
        'bundle-text:./check.svg': 'hyrDV',
        'bundle-text:./play.svg': 'eZys6',
        'bundle-text:./pause.svg': 'hITjK',
        'bundle-text:./volume.svg': 'hNNiX',
        'bundle-text:./volume-close.svg': 'dC2M2',
        'bundle-text:./screenshot.svg': '9hKk0',
        'bundle-text:./setting.svg': '47p50',
        'bundle-text:./arrow-left.svg': '5je49',
        'bundle-text:./arrow-right.svg': '2HKZ5',
        'bundle-text:./playback-rate.svg': 'hdBpQ',
        'bundle-text:./aspect-ratio.svg': 'alUG1',
        'bundle-text:./config.svg': '6B4Bn',
        'bundle-text:./pip.svg': '2Ya1d',
        'bundle-text:./lock.svg': '5Bna4',
        'bundle-text:./unlock.svg': 'daCyz',
        'bundle-text:./fullscreen-off.svg': 'bx7Yh',
        'bundle-text:./fullscreen-on.svg': 'fxY8n',
        'bundle-text:./fullscreen-web-off.svg': '96euD',
        'bundle-text:./fullscreen-web-on.svg': 'ccnBB',
        'bundle-text:./switch-on.svg': '26OlL',
        'bundle-text:./switch-off.svg': 'i0DjT',
        'bundle-text:./flip.svg': 'hdfqR',
        'bundle-text:./error.svg': '9sWnY',
        'bundle-text:./close.svg': 'hxSqS',
        'bundle-text:./airplay.svg': '52Tr6',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY'
      }
    ],
    gFMCI: [
    ...
    iYMJD: [
      function (e, t, r) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" height="60" width="60" style="filter:drop-shadow(0 1px 1px #000)" viewBox="0 0 24 24"><path d="M20 2H4C1.8 2 0 3.8 0 6v12c0 2.2 1.8 4 4 4h16c2.2 0 4-1.8 4-4V6c0-2.2-1.8-4-4-4zm-4.4 10.8L10.5 16c-.6.5-1.5 0-1.5-.8V8.8c0-.8.9-1.3 1.5-.8l5.1 3.2c.7.3.7 1.3 0 1.6z"/></svg>'
      },
      {}
    ],
    hyrDV: [
      ...
      function (e, t, r) {
        ...
        function m(e, t, r) {
          for (let o = 0; o < e.length; o++) {
            const i = e[o]
            ;(i.$parentItem = t), (i.$parentList = r), i.selector && m(i.selector, i, e)
          }
          return e
        }
        function g(e) {
        ...
        class y extends f.default {
          constructor(e) {
            ...
            if (
              ...
              t.playbackRate && this.option.push((0, c.default)(e)),
                t.aspectRatio && this.option.push((0, s.default)(e)),
                t.flip && this.option.push((0, a.default)(e)),
                t.subtitleOffset && this.option.push((0, u.default)(e))
              ...
              ;(this.option = m(this.option)),
                ...
                r(i, 'click', t => {
                  !this.show ||
                    (0, h.includeFromEvent)(t, e.controls.setting) ||
                    (0, h.includeFromEvent)(t, this.$parent) ||
                    ((this.show = !1), this.init(this.option))
                })
            }
          }
          add(e) {
            'function' == typeof e ? this.option.push(e(this.art)) : this.option.push(e),
              (this.cache = new Map()),
          ...
          creatHeader(e) {
            const { icons: t, proxy: r } = this.art,
              o = (0, h.createElement)('div')
            ...
            ;(0, h.addClass)(a, 'art-setting-item-left-icon'),
              (0, h.append)(a, t.arrowLeft),
              (0, h.append)(i, a),
              (0, h.append)(i, e.$parentItem.html)
            const n = r(o, 'click', () => {
              this.init(e.$parentList)
            })
            return this.events.push(n), o
          }
          creatItem(e, t) {
            const { icons: r, proxy: o } = this.art,
              i = (0, h.createElement)('div')
            ;(0, h.addClass)(i, 'art-setting-item'),
              g(t.name) && (i.dataset.name = t.name),
              g(t.value) && (i.dataset.value = t.value)
            ...
            switch (((0, h.addClass)(s, 'art-setting-item-left-icon'), e)) {
              case 'switch':
              case 'range':
                ;(0, h.append)(s, g(t.icon) || t.icon instanceof Element ? t.icon : r.config)
                break
              case 'selector':
                t.selector && t.selector.length
                  ? (0, h.append)(s, g(t.icon) || t.icon instanceof Element ? t.icon : r.config)
                  : (0, h.append)(s, r.check)
            }
            ;(0, h.append)(a, s),
              (t.$icon = s),
              (0, h.def)(t, 'icon', {
            ...
            ;(0, h.addClass)(l, 'art-setting-item-left-text'),
              (0, h.append)(l, t.html || ''),
              (0, h.append)(a, l),
              (t.$html = l),
              (0, h.def)(t, 'html', {
            ...
            switch (
              ((0, h.addClass)(c, 'art-setting-item-right-tooltip'),
              (0, h.append)(c, t.tooltip || ''),
              (0, h.append)(n, c),
              (t.$tooltip = c),
              (0, h.def)(t, 'tooltip', {
                configurable: !0,
              ...
              case 'switch': {
                ...
                ;(0, h.setStyle)(t.switch ? i : o, 'display', 'none'),
                  (0, h.append)(n, e),
                  (t.$switch = t.switch),
                  (0, h.def)(t, 'switch', {
                    configurable: !0,
                    ...
                    set(e) {
                      ;(t.$switch = e),
                        e
                          ? ((0, h.setStyle)(i, 'display', 'none'),
                            (0, h.setStyle)(o, 'display', null))
                          : ((0, h.setStyle)(i, 'display', null),
                            (0, h.setStyle)(o, 'display', 'none'))
                    }
                  })
                break
              }
              case 'range':
                {
                  ...
                  ;(r.value = t.range[0] || 0),
                    ...
                    (r.max = t.range[2] || 10),
                    (r.step = t.range[3] || 1),
                    (0, h.addClass)(r, 'art-setting-range'),
                    (0, h.append)(n, e),
                    (t.$range = r),
                    (0, h.def)(t, 'range', {
                      configurable: !0,
              ...
              case 'selector': {
                const e = o(i, 'click', async e => {
                  if (t.selector && t.selector.length) this.init(t.selector, t.width)
                    ...
                    t.$parentList && this.init(t.$parentList),
                    t.$parentItem && t.$parentItem.onSelect)
                  ) {
                    const r = await t.$parentItem.onSelect.call(this.art, t, i, e)
                    t.$parentItem.$tooltip && g(r) && (t.$parentItem.$tooltip.innerHTML = r)
                  }
                })
          ...
          init(e, t) {
            ...
            if (this.cache.has(e)) {
              ...
              ;(0, h.inverseClass)(t, 'art-current'),
                (0, h.setStyle)(this.$parent, 'width', `${t.dataset.width}px`),
                (0, h.setStyle)(this.$parent, 'height', `${t.dataset.height}px`)
            } else {
              const o = (0, h.createElement)('div')
              ;(0, h.addClass)(o, 'art-setting-panel'),
                (o.dataset.width = t || r.SETTING_WIDTH),
                (o.dataset.height = e.length * r.SETTING_ITEM_HEIGHT),
                e[0] &&
                  e[0].$parentItem &&
                  ((0, h.append)(o, this.creatHeader(e[0])),
                  (o.dataset.height = Number(o.dataset.height) + r.SETTING_ITEM_HEIGHT))
              for (let t = 0; t < e.length; t++) {
                const r = e[t]
                ;(0, h.has)(r, 'switch')
                  ? (0, h.append)(o, this.creatItem('switch', r))
                  : (0, h.has)(r, 'range')
                  ? (0, h.append)(o, this.creatItem('range', r))
                  : (0, h.append)(o, this.creatItem('selector', r))
              }
              ;(0, h.append)(this.$parent, o),
                this.cache.set(e, o),
                (0, h.inverseClass)(o, 'art-current'),
                (0, h.setStyle)(this.$parent, 'width', `${o.dataset.width}px`),
                (0, h.setStyle)(this.$parent, 'height', `${o.dataset.height}px`),
                e[0] &&
                  e[0].$parentItem &&
    ...
    eyzeE: [
      function (e, t, r) {
        ...
        var o = e('../utils')
        r.default = function (e) {
          const { i18n: t, icons: r, constructor: i } = e,
            a = { normal: 'Normal', horizontal: 'Horizontal', vertical: 'Vertical' }
          function n(e, r, i) {
            r && (r.innerText = t.get(a[i]))
            const n = (0, o.queryAll)('.art-setting-item', e).find(e => e.dataset.value === i)
            n && (0, o.inverseClass)(n, 'art-current')
          }
          return {
            width: i.SETTING_ITEM_WIDTH,
            html: t.get('Video Flip'),
            tooltip: t.get(a[e.flip]),
            icon: r.flip,
            selector: Object.keys(a).map(r => ({
              value: r,
              default: r === e.flip,
              html: t.get(a[r])
            })),
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          return {
            ...
            icon: r.aspectRatio,
            tooltip: a(e.aspectRatio),
            selector: ['default', '4:3', '16:9'].map(t => ({
              value: t,
    ...
    aowja: [
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          function n(e, t, r) {
            t && (t.innerText = a(r))
            const i = (0, o.queryAll)('.art-setting-item', e).find(
          ...
          return {
            ...
            tooltip: a(e.playbackRate),
            icon: r.playbackRate,
            selector: [0.5, 0.75, 1, 1.25, 1.5, 2].map(t => ({
              value: t,
    ...
    '1v13t': [
      function (e, t, r) {
        ...
        r.default = class {
          constructor(e) {
            ...
            const { option: t } = e
            t.miniProgressBar && !t.isLive && this.add(n.default),
              t.lock && i.isMobile && this.add(h.default),
              t.autoPlayback && !t.isLive && this.add(p.default),
              t.autoOrientation && i.isMobile && this.add(l.default),
              t.fastForward && i.isMobile && !t.isLive && this.add(d.default)
      ...
      {
        '../utils': '5yYFo',
        './miniProgressBar': '2h4YZ',
        './autoOrientation': 'bcdCk',
        './autoPlayback': '1nHHC',
        './fastForward': '4gkmX',
        './lock': 'ij5nM',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'b7MJY'
        ...
        r.default = function (e) {
          ...
          return (
            e.on('fullscreenWeb', n => {
              if (n) {
                const { videoWidth: t, videoHeight: n } = a,
                  { clientWidth: s, clientHeight: l } = document.documentElement
                ;((t > n && s < l) || (t < n && s > l)) &&
                  setTimeout(() => {
                    ;(0, o.setStyle)(i, 'width', `${l}px`),
                      (0, o.setStyle)(i, 'height', `${s}px`),
                      (0, o.setStyle)(i, 'transform-origin', '0 0'),
                      (0, o.setStyle)(i, 'transform', `rotate(90deg) translate(0, -${s}px)`),
                      (0, o.addClass)(i, 'art-auto-orientation'),
                      (e.isRotate = !0),
                      e.emit('resize')
                  }, r.MOBILE_AUTO_ORIENTATION_TIME)
              } else
                (0, o.hasClass)(i, 'art-auto-orientation') &&
                  ((0, o.setStyle)(i, 'width', null),
                  (0, o.setStyle)(i, 'height', null),
                  (0, o.setStyle)(i, 'transform', null),
                  (0, o.setStyle)(i, 'transform-origin', null),
                  (0, o.removeClass)(i, 'art-auto-orientation'),
                  (e.isRotate = !1),
                  (e.aspectRatioReset = !0),
                  (e.autoSize = t.autoSize),
                  (e.notice.show = ''),
            ...
            e.on('fullscreen', async e => {
              ...
              if (e) {
                const { videoWidth: e, videoHeight: r } = a,
                ...
                if ((e > r && n < s) || (e < r && n > s)) {
                  ...
                  await screen.orientation.lock(e),
                    (0, o.addClass)(i, 'art-auto-orientation-fullscreen')
                }
              } else
                (0, o.hasClass)(i, 'art-auto-orientation-fullscreen') &&
                  (await screen.orientation.lock(t),
                  (0, o.removeClass)(i, 'art-auto-orientation-fullscreen'))
            }),
            {
      ...
      function (e, t, r) {
        ...
        r.default = function (e) {
          const {
            ...
            c = (0, o.query)('.art-autoPlayback-last', l),
            p = (0, o.query)('.art-autoPlayback-jump', l),
            u = (0, o.query)('.art-autoPlayback-close', l)
          return (
            e.on('video:timeupdate', () => {
              const t = i.get('times') || {},
                r = Object.keys(t)
            ...
            e.on('ready', () => {
              ...
              d &&
                ...
                (c.innerText = `${t.get('Last Seen')} ${(0, o.secondToTime)(d)}`),
    ...
    '4gkmX': [
      function (e, t, r) {
        ...
        r.default = function (e) {
          ...
          const l = () => {
            clearTimeout(n),
              s && ((s = !1), (e.playbackRate = 1), (0, o.removeClass)(i, 'art-fast-forward'))
          }
          return (
            r(a, 'touchstart', r => {
              1 === r.touches.length &&
                ...
                (n = setTimeout(() => {
                  ;(s = !0),
                    ...
                    (0, o.addClass)(i, 'art-fast-forward')
                }, t.FAST_FORWARD_TIME))
            }),
            r(document, 'touchmove', l),
            r(document, 'touchend', l),
            {
              name: 'fastForward',
              get state() {
        ...
        r.default = function (e) {
          ...
          return (
            t.add({
              ...
              click() {
                ;(0, o.hasClass)(i, 'art-lock')
                  ? ((0, o.removeClass)(i, 'art-lock'), (this.isLock = !1), e.emit('lock', !1))
                  : ((0, o.addClass)(i, 'art-lock'), (this.isLock = !0), e.emit('lock', !0))
              }
            }),
            {
              name: 'lock',
      ...
      function (e, t, r) {
        ...
        r.default = class {
          constructor(e) {
            ...
            for (let t = 0; t < a.default.events.length; t++)
              r(o, a.default.events[t], t => {
                e.emit(`video:${t.type}`, t)
              })
            Object.keys(t.moreVideoAttr).forEach(e => {
              o[e] = t.moreVideoAttr[e]
            }),
              t.muted && (o.muted = t.muted),
              t.volume && (o.volume = (0, n.clamp)(t.volume, 0, 1)),
              t.poster && (o.poster = t.poster),
              t.autoplay && (o.autoplay = t.autoplay),
              t.playsInline && ((o.playsInline = !0), (o['webkit-playsinline'] = !0))
            const i = t.type || (0, n.getExt)(t.url),
              s = t.customType[i]
            i && s
              ? (s(o, t.url, e), e.emit('customType', i))
              : ((o.src = t.url), e.emit('url', o.src))
          }
        }
      },
      {
